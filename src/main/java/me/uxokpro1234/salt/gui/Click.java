package me.uxokpro1234.salt.gui;

import me.uxokpro1234.salt.gui.comps.CategoryComponent;
...
public class Click extends GuiScreen {
    public List<CategoryComponent> categoryComponentList = new LinkedList<CategoryComponent>();
